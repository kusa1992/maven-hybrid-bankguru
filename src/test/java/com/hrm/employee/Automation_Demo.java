...
public class Automation_Demo extends BaseTest {
	...
	public void Employee_01_Add_New_Employee() {
		...
		log.info("Add_New_01 - Step 03: Enter valid info to 'First Name' textbox with value: " + empFirstName);
		addEmployeePage.enterToTextBoxByID(driver, "firstName", empFirstName);

		log.info("Add_New_01 - Step 04: Enter valid info to 'Last Name' textbox with value: " + empLastName);
		...
		log.info("Add_New_01 - Step 07: Enter valid info to 'User Name' textbox with value: " + empUserName);
		...
		log.info("Add_New_01 - Step 13: Enter valid info to 'Employee Name' textbox with value: " + empFullName);
	...
	@Description("Upload Employee's Avatar")
	@Story("Upload file")
	@Severity(SeverityLevel.NORMAL)
	@Test
	public void Employee_02_Upload_Avatar() {
		log.info("Upload_Avatar_02 - Step 01: Login with Employee role: " + empUserName + ", " + Employee.AddEmployee.PASSWORD);
		loginPage = employeeListPage.logoutToSystem(driver);
		dashboardPage = loginPage.loginToSystem(driver, empUserName, Employee.AddEmployee.PASSWORD);
	...
	public void Employee_03_Personal_Details() {
		...
		log.info("Personal_Details_03 - Step 09: Enter new value to 'First Name' textbox with value: " + editFirstName);
		myInfoPage.enterToTextBoxByID(driver, "personal_txtEmpFirstName", editFirstName);

		log.info("Personal_Details_03 - Step 10: Enter new value to 'Last Name' textbox with value: " + editLastName);
		myInfoPage.enterToTextBoxByID(driver, "personal_txtEmpLastName", editLastName);
		...
		verifyEquals(myInfoPage.getTextboxValueByID(driver, "personal_txtEmpFirstName"), editFirstName);

		log.info("Personal_Details_03 - Step 17: Verify 'Last Name' textbox is updated successfully");
		verifyEquals(myInfoPage.getTextboxValueByID(driver, "personal_txtEmpLastName"), editLastName);
		...
		verifyEquals(myInfoPage.getSelectedValueInDropdownByID(driver, "personal_cmbMarital"), "Married");
	...
	DataUtil fakeData;
	WebDriver driver;
	String employeeID, empFirstName, empLastName, empFullName, empUserName, editFirstName, editLastName, editFullName;
